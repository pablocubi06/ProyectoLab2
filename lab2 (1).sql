...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-10-2023 a las 22:30:49
...
INSERT INTO `ordenes` (`codigo`, `idPaciente`, `fechaIngreso`, `fechaEntrega`, `pre_diagnostico`, `estado`, `tpoMuestras`) VALUES
...
CREATE TABLE `personas` (
  ...
  `ciudad:nac` varchar(15) NOT NULL,
...
INSERT INTO `personas` (`dni`, `apellido`, `nombre`, `sexo`, `fecha_nac`, `ciudad:nac`, `pais_nac`, `embarazada`, `patolog_prev`, `tipo_usuario`, `mail`, `telefono`) VALUES
('40123456', 'Sosa', 'Sofia', 'F', '1995-10-10', 'San Luis', 'Argentina', 0, 'no', 'Paciente', 'sofi@gmail.com', '2664356789');
